...
| factory-ux-critic       | parent model (no pin)                    | exercises the app and reports; inherits the session so Cursor is not forced onto Other Models / sonnet                                                                                                                                                                      |
