...
const shake256_114 = /* @__PURE__ */ wrapConstructor(() =>
  shake256.create({ dkLen: 114 }),
);
const shake256_64 = /* @__PURE__ */ wrapConstructor(() =>
  shake256.create({ dkLen: 64 }),
);
// prettier-ignore
...
const Fn448 = /* @__PURE__ */ (() =>
  Field(ed448_CURVE.n, { BITS: 448, isLE: true }))();
 ...
 * ```
 */
export const ed448_hasher = /* @__PURE__ */ (() =>
  createHasher(
    ed448_Point,
    (scalars) => map_to_curve_elligator2_edwards448(scalars[0]),
    {
 ...
 * ```
 */
export const ed448_FROST = /* @__PURE__ */ (() =>
  createFROST({
...
function calcElligatorDecafMap(r0) {
  ...
  const W3 = Fp448.add(
    Fp448.mulN(
      Fp448.mulN(Fp448.mulN(v_prime, s), Fp448.subN(r, _1n)),
      ONE_MINUS_TWO_D,
    ),
    sgn,
  ); // 11
...
class _DecafPoint extends PrimeEdwardsPoint {
  ...
  static fromBytes(bytes) {
    ...
    let u3 = Fp448.mul(
      Fp448.mulN(Fp448.mulN(Fp448.addN(s, s), invsqrt), u1),
      SQRT_MINUS_D,
    ); // 5
    if (Fp448.isOdd(u3)) u3 = Fp448.neg(u3);
    const x = Fp448.mul(
      Fp448.mulN(Fp448.mulN(u3, invsqrt), u2),
      INVSQRT_MINUS_D,
    ); // 6
  ...
  toBytes() {
    ...
    const { value: invsqrt } = invertSqrt(
      Fp448.mul(Fp448.mulN(u1, ONE_MINUS_D), x2),
    ); // 2
...
export const decaf448_hasher = /* @__PURE__ */ Object.freeze({
  ...
  hashToCurve(msg, options) {
    ...
    const DST =
      options?.DST === undefined
        ? "decaf448_XOF:SHAKE256_D448MAP_RO_"
        : options.DST;
    return decaf448_hasher.deriveToCurve(
      expand_message_xof(msg, DST, 112, 224, shake256),
    );
  },
  /**
  ...
  deriveToCurve(bytes) {
    ...
    const r1 = Fp448.create(
      Fp448.fromBytes(bytes.subarray(0, 56), skipValidation),
    );
    const R1 = calcElligatorDecafMap(r1);
    const r2 = Fp448.create(
      Fp448.fromBytes(bytes.subarray(56, 112), skipValidation),
    );
 ...
 * ```
 */
export const decaf448_oprf = /* @__PURE__ */ (() =>
  createOPRF({
