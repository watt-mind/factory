...
function createKeyUtils(algo, derive, keyLen, pkcs8header) {
  ...
  const arrBufToU8 = (res, format) =>
    format === TYPE_JWK ? res : new Uint8Array(res);
  const pub = {
    async import(key, format) {
      ...
      const keyi = await getSubtle().importKey(
        format,
        key,
        algo,
        true,
  ...
  const priv = {
    ...
    async export(key, format) {
      ...
      if (format === TYPE_RAW) {
        ...
        const pad =
          base64.length % 4 ? "=".repeat(4 - (base64.length % 4)) : ""; // add padding
  ...
  async function getPublicKey(secretKey, opts = {}) {
    validateObject(
      opts,
      {},
      { formatSec: "string", formatPub: "string" },
      "opts",
    );
    ...
    const jwk =
      fsec === TYPE_JWK
        ? { ...secretKey }
        : await priv.convert(secretKey, fsec, TYPE_JWK);
    delete jwk.d;
      ...
      try {
        ...
        if (derive) {
          await crypto.deriveBits(
            {
              name: typeof algo === "string" ? algo : algo.name,
 ...
 * ```
 */
export const p256 = /* @__PURE__ */ wrapECDSA(
  "P-256",
  "SHA-256",
  32,
 ...
 * ```
 */
export const p384 = /* @__PURE__ */ wrapECDSA(
  "P-384",
  "SHA-384",
  48,
 ...
 * ```
 */
export const p521 = /* @__PURE__ */ wrapECDSA(
  "P-521",
  "SHA-512",
  66,
 ...
 * ```
 */
export const ed25519 = /* @__PURE__ */ wrapEdDSA(
  "Ed25519",
  32,
 ...
 * ```
 */
export const ed448 = /* @__PURE__ */ wrapEdDSA(
  "Ed448",
  57,
 ...
 * ```
 */
export const x25519 = /* @__PURE__ */ wrapMontgomery(
  "X25519",
  32,
 ...
 * ```
 */
export const x448 = /* @__PURE__ */ wrapMontgomery(
  "X448",
  56,
