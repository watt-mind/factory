...
class BLAKE1 {
  ...
  _cloneIntoMeta(to) {
    ...
    else if (to.destroyed || (!to.finished && (to.length || to.pos)))
      clean(to.buffer);
 ...
 * ```
 */
export const blake224 = /* @__PURE__ */ createHasher(
 ...
 * ```
 */
export const blake256 = /* @__PURE__ */ createHasher(
 ...
 * ```
 */
export const blake384 = /* @__PURE__ */ createHasher(
 ...
 * ```
 */
export const blake512 = /* @__PURE__ */ createHasher(
