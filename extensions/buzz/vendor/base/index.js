 ...
 * ```
 */
export const base16 = /* @__PURE__ */ freeze(() =>
 ...
 * ```
 */
export const base32 = /* @__PURE__ */ freeze(() =>
 ...
 * ```
 */
export const base32nopad = /* @__PURE__ */ freeze(() =>
 ...
 * ```
 */
export const base32hex = /* @__PURE__ */ freeze(() =>
 ...
 * ```
 */
export const base32hexnopad = /* @__PURE__ */ freeze(() =>
 ...
 * ```
 */
export const base32crockford = /* @__PURE__ */ freeze(() =>
  chain(
    radix2(5),
...
const base64Fallback = /* @__PURE__ */ freeze(() =>
  chain(
    radix2(6),
    alphabet(
 ...
 * ```
 */
export const base64nopad = /* @__PURE__ */ freeze(() =>
  chain(
    radix2(6),
    alphabet(
      "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
 ...
 * ```
 */
export const base64urlnopad = /* @__PURE__ */ freeze(() =>
  chain(
    radix2(6),
    alphabet(
...
const radix58 = {
  ...
  decode: (digits) => {
    ...
    // zero digit does.
    const valueBytes =
      used === 0 ? 1 : used * 2 - (limbs[used - 1] < 256 ? 1 : 0);
 ...
 * ```
 */
export const base58 = /* @__PURE__ */ freeze(() =>
 ...
 * ```
 */
export const base58flickr = /* @__PURE__ */ freeze(() =>
 ...
 * ```
 */
export const base58xrp = /* @__PURE__ */ freeze(() =>
...
export const createBase58check = (sha256) => {
  ...
  return chain(
    checksum(4, (data) => _sha256(_sha256(data))),
    base58,
  );
};
/**
...
const BECH_ALPHABET = /* @__PURE__ */ alphabet(
...
function genBech32(encoding) {
  ...
  function decode(str, limit = 90) {
    ...
    if (slen < 8 || (limit !== false && slen > limit))
      throw new TypeError(
        `invalid string length ${slen}, expected (8..${limit})`,
      );
    ...
    for (let i = 0; i < str.length; i++) {
      ...
      if (charCode > 127)
        throw new RangeError(
          `non-ASCII char "${str[i]}" (${charCode}) at ${i}`,
        );
      res[i] = charCode;
    }
    return res;
 ...
 * ```
 */
export const hex = /* @__PURE__ */ freeze(() =>
  hasHexBuiltin
    ? hexBuiltin
    : chain(
        radix2(4),
